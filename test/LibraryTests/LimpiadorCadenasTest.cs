...
namespace Test.Library
{
    ...
    public class LimpiadorCadenasTests
    {
        ...
        public void TestLimpiaCadena()
        {
            ...
            Assert.AreEqual(expected, LimpiadorCadena.LimpiaCadena(cadena));
        }
        ...
        /// para este test utilizaremos la cadena "Hola, COMO estás?" que contiene todos los elementos 
        /// para testear.
        /// </summary>
        [Test]
        public void TestLimpiaCadenaRespuesta()
        {
            ...
            Assert.AreEqual(expected, LimpiadorCadena.LimpiaCadenaRespuesta(cadena));
        }
    }
}