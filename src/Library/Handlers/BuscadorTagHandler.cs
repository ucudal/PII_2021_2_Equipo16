...
namespace ClassLibrary
{
    ...
    public class BuscadorTagHandler : BaseHandler
    {
        ...
        protected override bool InternalHandle(IMensaje mensaje, out string respuesta)
        {
            ...
            if (ContenedorPrincipal.Instancia.HistorialDeChats[mensaje.Id].ComprobarUltimoComandoIngresado("/buscartag") == true)
            {
                List<string> listaConParametros = ContenedorPrincipal.Instancia.HistorialDeChats[mensaje.Id].BuscarUltimoComando("/buscartag");
