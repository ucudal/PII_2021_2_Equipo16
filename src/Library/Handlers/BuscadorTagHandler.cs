...
{
    /// <summary>
    /// Un "handler" del patrón Chain of Responsibility que implementa el comando "/buscartag".
    /// </summary>
    public class BuscadorTagHandler : BaseHandler
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase Esta clase procesa el mensaje "buscartag".
        /// </summary>
        ...
        /// <summary>
        /// Este método procesa el mensaje "Buscar por Tag" y retorna true.
